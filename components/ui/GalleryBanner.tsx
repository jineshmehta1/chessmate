        ...
        <div className="container mx-auto px-12">
          <div className="flex justify-between items-center text-white/30">
            <div className="flex items-center gap-3 group cursor-default">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest group-hover:text-white transition-colors">Tournament Highlights</span>
            </div>
            <div className="flex items-center gap-3 group cursor-default">
              <Layout className="w-4 h-4 text-[#EAB308]" />
              <span className="text-[10px] font-bold uppercase tracking-widest group-hover:text-white transition-colors">Training Sessions</span>
            </div>
            <div className="flex items-center gap-3 group cursor-default">
              <Aperture className="w-4 h-4 text-[#EAB308]" />
              <span className="text-[10px] font-bold uppercase tracking-widest group-hover:text-white transition-colors">Student Celebrations</span>
            </div>
          </div>
        </div>
      </div>
