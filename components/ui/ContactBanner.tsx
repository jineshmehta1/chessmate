...
const ConnectBanner: React.FC = () => {
  return (
    <div className="relative w-full bg-white overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24 selection:bg-yellow-400 selection:text-black">
      ...
      >
        <Mail className="w-12 h-12 md:w-20 md:h-20" strokeWidth={1} />
      </motion.div>
      ...
      <motion.div 
        ...
        className="absolute bottom-32 right-[12%] md:right-[18%] w-10 h-10 md:w-14 md:h-14 bg-white border-2 border-black rounded-xl flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-10"
      >
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] md:tracking-[0.4em] text-black italic">Get In Touch</span>
          <div className="h-[2px] w-6 md:w-8 bg-yellow-400"></div>
        </div>
        ...
        <h1 className="text-2xl md:text-5xl lg:text-6xl font-black text-black leading-none uppercase italic mb-10 tracking-tight">
          Contact <span className="text-white [-webkit-text-stroke:1px_black] md:[-webkit-text-stroke:2px_black] drop-shadow-[4px_4px_0px_rgba(253,224,71,1)]">Us.</span>
        </h1>
        ...
        <nav className="inline-flex items-center gap-2 md:gap-3 bg-black text-white px-5 py-2.5 md:px-8 md:py-4 rounded-2xl border-[3px] md:border-4 border-black shadow-[5px_5px_0px_0px_rgba(253,224,71,1)] md:shadow-[8px_8px_0px_0px_rgba(253,224,71,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all cursor-pointer">
          <Link href="/" className="text-[9px] md:text-[11px] font-black uppercase tracking-widest hover:text-yellow-400 transition-colors">
            Home
          </Link>
      ...
      >
        <Send className="w-6 h-6 md:w-8 md:h-8 text-black fill-yellow-400" />
      </motion.div>
